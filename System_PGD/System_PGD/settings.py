"""
Django settings for System_PGD project.
...
SECRET_KEY = 'django-insecure-gq!103@!qy^_zhf9td#u7+(i@1m@yj1tm-ft^r628yf$%j=f6#'
...
WSGI_APPLICATION = 'System_PGD.wsgi.application'
